    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-end gap-4 mt-2">
          <div className="flex items-center gap-3 bg-white/5 rounded-md px-3 py-1">
            <Switch
              checked={viewMode === "event"}
              onCheckedChange={(checked) =>
                setViewMode(checked ? "event" : "lifetime")
              }
              className="scale-90"
            />
            <div className="text-sm text-slate-700">
              {viewMode === "event" ? "Per Event" : "Lifetime"}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white/95 rounded-lg shadow-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-md font-semibold">Applications by Status</h3>
              <p className="text-sm text-slate-500">Percentage breakdown</p>
            </div>
            <div className="h-64">
          ...
          <div className="bg-white/95 rounded-lg shadow-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-md font-semibold">Education Demographics</h3>
              <p className="text-sm text-slate-500">
                Jobseeker count by education
              </p>
            </div>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="mt-4">
          <div className="bg-white/95 rounded-lg shadow-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-md font-semibold">Job Trend</h3>
              <p className="text-sm text-slate-500">
